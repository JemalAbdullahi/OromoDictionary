...
// in oromo_dictionary/test/features/english_oromo_dictionary/presentation/bloc/search_page_bloc/search_page_bloc_test.dart.
...
class MockGetEnglishWordList extends _i1.Mock
    implements _i4.GetEnglishWordList {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockGetOromoWordList extends _i1.Mock implements _i7.GetOromoWordList {
  ...
  _i2.EnglishOromoDictionaryRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          ...
          as _i2.EnglishOromoDictionaryRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<dynamic>>> call(_i7.Params? params) =>
      (super.noSuchMethod(Invocation.method(#call, [params]),
              returnValue: Future<_i3.Either<_i6.Failure, List<dynamic>>>.value(
                  _FakeEither_1<_i6.Failure, List<dynamic>>()))
          as _i5.Future<_i3.Either<_i6.Failure, List<dynamic>>>);
